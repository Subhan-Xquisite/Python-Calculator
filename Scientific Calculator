...
# THIS IS THE GUI MODULE INSERTATION INTO THE PYTHON CODE FOR THE FURTHER FRAME AND CONTACT WITH OTHER ARITHEMTIC SYSTEM
root = Tk()
root.title("3RDSIMPLECALCULATORANDSCIENTIFICCALCULATORMADEBYLEGENDGAMER5208")
root.configure(background = 'wheat')
root.resizable(width=False, height=False)
root.geometry("480x568+00+00")
calc = Frame(root)
calc.grid()
...
# ALL THE FORMATS OF SYSTEMS AND BUTTONS THAT WILL BE USED IN THE SCIENTIFIC AND SIMPLE CALCUALTOR MADE BY LEGENDGAMER5208
...
btnPM = Button(calc, text=chr(177),width=6,
			height=2,bg='deepskyblue1', font=('arial',20,'bold'),
...
lblDisplay = Label(calc, text = "Scientific Calculator",
				font=('times',30,'bold'),
				bg='limegreen',fg='black',justify=CENTER)
...
def iExit():
	iExit = tkinter.messagebox.askyesno("3RDSIMPLECALCULATORANDSCIENTIFICCALCULATORMADEBYLEGENDGAMER5208",
